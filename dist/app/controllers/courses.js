...
function create(req, res) {
  ...
  db.collection('courses').insert(course, function (err, result) {
    if (err) {
...
function update(req, res) {
  ...
  db.collection('courses').update(details, course, function (err, result) {
    if (err) {
...
function get(req, res) {
  ...
  db.collection('courses').findOne(details, function (err, course) {
    if (err) {
...
function remove(req, res) {
  ...
  db.collection('courses').remove(details, function (err, result) {
    if (err) {
